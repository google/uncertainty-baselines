...
"""SNGP + Rank-1 BNN Wide ResNet 28-10 on CIFAR-10 and CIFAR-100.
...
## Rank-1 Bayesian neural net (Rank-1 BNN) [3]:

A Rank-1 BNN is an efficient and scalable approach to variational BNNs that
posits prior distributions on rank-1 factors of the weights and optimizes
global mixture variational posterior distributions.
...
[3]: Michael W. Dusenberry*, Ghassen Jerfel*, Yeming Wen, Yian Ma, Jasper
...
def main(argv):
  ...
  train_dataset_size = int(ds_info.splits['train'].num_examples *
  ...
  with strategy.scope():
    ...
    model = ub.models.wide_resnet_sngp_rank1(
    ...
    def step_fn(inputs):
      ...
      if FLAGS.fast_weight_lr_multiplier != 1.0:
        ...
        for grad, var in zip(grads, model.trainable_variables):
          ...
          # TODO(ghassen): ('bias' not in var.name) is used for R1 but not BE ?
