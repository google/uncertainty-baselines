...
r"""ViT-L/32 + Heteroscedastic finetuning on RETINA.
...
def get_config():
  ...
  config.model_init = ('gs://ub-checkpoints/ImageNet21k_Het-ViT-L32/'
                       'checkpoint.npz')
  config.data_dir = 'gs://ub-data/retinopathy'
  # The directory where the model weights and training/evaluation summaries
  #   are stored.
  config.output_dir = (
      '/tmp/diabetic_retinopathy_detection/vit-32-i21k/heteroscedastic')
