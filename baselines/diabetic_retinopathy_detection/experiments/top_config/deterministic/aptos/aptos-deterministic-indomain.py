...
r"""Top hyperparameter configuration of the deterministic baseline for Diabetic Retinopathy Detection, tuning on in-domain validation AUC, evaluated on the OOD APTOS Indian retinopathy dataset with moderate decision threshold.
"""
