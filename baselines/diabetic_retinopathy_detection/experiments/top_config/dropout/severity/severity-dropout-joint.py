...
r"""Top hyperparameter configuration of the MC Dropout baseline for Diabetic Retinopathy Detection, tuning on area under the balanced joint SP-Accuracy curve, evaluated on the Severity Shift with moderate decision threshold.
"""
