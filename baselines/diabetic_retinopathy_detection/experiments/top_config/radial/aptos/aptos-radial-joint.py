...
r"""Top hyperparameter configuration of the Radial baseline for Diabetic Retinopathy Detection, tuning on area under the balanced joint SP-Accuracy curve, evaluated on the OOD APTOS Indian retinopathy dataset with moderate decision threshold.
"""
