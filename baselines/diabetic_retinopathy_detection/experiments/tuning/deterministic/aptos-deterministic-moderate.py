...
r"""Deterministic baseline for Diabetic Retinopathy Detection, evaluated on the OOD APTOS Indian retinopathy dataset with moderate decision threshold.
"""
...
def get_config():
  ...
  output_dir = 'gs://drd-deterministic-aptos-results/{}'.format(
      config.experiment_name)
  config.args = {
