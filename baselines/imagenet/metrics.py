...
author: who/iosband
source: l/d/r/efficient_agent/tf/metrics.py

This is a collection of tensorflow functions designed to add an evaluation of
joint NLL to uncertainty_baselines code. For ease of compatibility we look at
a simplified form of "dyadic sampling" that does not require extra forward
passes on any new data, and so should be easy to integrate into existing infra.

Evaluating High-Order Predictive Distributions in Deep Learning
https://arxiv.org/abs/2202.13509
