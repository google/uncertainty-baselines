...
def get_ids_logits_masks(*,
  ...
  for batch in iter_ds:
    ...
    # TODO(joost,andreas): if we run on multi host, we need to index batch_outputs:
    # batch_outputs[0]
    ids.append(batch_id)
...
def main(config):
  ...
  # TODO(joost,andreas): double check if below is still necessary (train_split is independent of this)
