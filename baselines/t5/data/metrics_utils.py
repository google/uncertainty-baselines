...
for data_name, intent_list in INTENT_DICT.items():
  ...
  for idex, name in enumerate(SNIPS_MTOP_ARG_EDGES + intent_list):
    name_to_token_map[name] = SPECIAL_TOKENS[idex]
    token_to_name_map[SPECIAL_TOKENS[idex]] = name
  NAME_TO_TOKEN_MAPS[data_name] = name_to_token_map
  TOKEN_TO_NAME_MAPS[data_name] = token_to_name_map
...
for idex, name in enumerate(SMCALFLOW_ARG_EDGES + SMCALFLOW_NODES):
  name_to_token_map[name] = SPECIAL_TOKENS[idex]
  token_to_name_map[SPECIAL_TOKENS[idex]] = name
NAME_TO_TOKEN_MAPS['smcalflow'] = name_to_token_map
TOKEN_TO_NAME_MAPS['smcalflow'] = token_to_name_map
