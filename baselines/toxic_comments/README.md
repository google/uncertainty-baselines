...
| ----------- | ----------- | ----------- | ----------- | ----------- | ----------- |
| Deterministic                           | 0.9734/0.8019/0.9231 | 0.0245/0.0548 | 0.9230/0.9175 | 0.9934/0.9932 |
| SNGP                                    | 0.9741/0.8029/0.9233 | 0.0280/0.0548 | 0.9238/0.9171 | 0.9932/0.9932 |
| Monte Carlo Dropout                     | 0.9729/0.8006/0.9274 | 0.0198/0.0508 | 0.9282/0.9179 | 0.9942/0.9936 |
| Ensemble<sup>1</sup> (size=10)          | 0.9738/0.8074/0.9231 | 0.0235/0.0544 | 0.9245/0.9172 | 0.9935/0.9932 |
| SNGP Ensemble (size=10)                 | 0.9741/0.8045/0.9226 | 0.0281/0.0549 | 0.9249/0.9170 | 0.9933/0.9931 |
| Deterministic + Focal Loss<sup>2</sup>  | 0.9730/0.8036/0.9476 | 0.1486/0.0628 | 0.9405/0.9123 | 0.9966/0.9950 |
| SNGP + Focal Loss                       | 0.9736/0.8076/0.9455 | 0.0076/0.0388 | 0.9385/0.9142 | 0.9963/0.9950 |
| Monte Carlo Dropout + Focal Loss        | 0.9741/0.8076/0.9472 | 0.1442/0.0622 | 0.9425/0.9146 | 0.9967/0.9951 |
| Ensemble + Focal Loss (size=10)         | 0.9735/0.8077/0.9479 | 0.1536/0.0639 | 0.9418/0.9126 | 0.9967/0.9951 |
| SNGP Ensemble + Focal Loss (size=10)    | 0.9742/0.8122/0.9467 | 0.0075/0.0379 | 0.9400/0.9140 | 0.9965/0.9951 |
...
In practice, it is common for a trained toxicity detection model to be deployed in a noisy environment with greater topical diversity and distribution shift.
...
| Method | AUROC/AUPRC/Acc | ECE/Brier Score | Calib AUROC (u/t) | Calib AUPRC (u/t) |
| ----------- | ----------- | ----------- | ----------- | ----------- | ----------- |
| Deterministic                        | 0.7796/0.6689/0.9628 | 0.0128/0.0246 | 0.9412/0.9649 | 0.9975/0.9984 |
| SNGP                                 | 0.7695/0.6665/0.9640 | 0.0070/0.0253 | 0.9457/0.9651 | 0.9977/0.9984 |
| Monte Carlo Dropout                  | 0.7806/0.6727/0.9671 | 0.0136/0.0241 | 0.9502/0.9631 | 0.9981/0.9985 |
| Ensemble (size=10)                   | 0.7849/0.6741/0.9625 | 0.0141/0.0242 | 0.9420/0.9660 | 0.9975/0.9984 |
| SNGP Ensemble (size=10)              | 0.7749/0.6719/0.9633 | 0.0076/0.0248 | 0.9463/0.9661 | 0.9977/0.9984 |
| Deterministic + Focal Loss           | 0.8013/0.6766/0.9795 | 0.1973/0.0377 | 0.9444/0.9427 | 0.9987/0.9986 |
| SNGP + Focal Loss                    | 0.8003/0.6820/0.9784 | 0.0182/0.0264 | 0.9465/0.9465 | 0.9987/0.9986 |
| Monte Carlo Dropout + Focal Loss     | 0.8009/0.6790/0.9790 | 0.1896/0.0360 | 0.9481/0.9470 | 0.9987/0.9987 |
| Ensemble + Focal Loss (size=10)      | 0.8041/0.6814/0.9795 | 0.1998/0.0381 | 0.9461/0.9444 | 0.9987/0.9987 |
| SNGP Ensemble + Focal Loss (size=10) | 0.8002/0.6827/0.9790 | 0.0176/0.0266 | 0.9481/0.9471 | 0.9987/0.9987 |
