...
class WideResnetBlock(nn.Module):
  ...
  def apply(self,
    ...
    y = nn.Conv(y, channels, (3, 3), strides, padding='SAME', name='conv1',
                kernel_init=initializers.kaiming_normal(), bias=False)
...
class WideResnet(nn.Module):
  ...
  def apply(self,
    ...
    #   x = [nn.Conv(
    #       x2, 16, (3, 3), padding='SAME', name='init_conv_%d' % i)
    ...
    x = nn.Dense(x, num_outputs, kernel_init=initializers.kaiming_normal())
    return x
