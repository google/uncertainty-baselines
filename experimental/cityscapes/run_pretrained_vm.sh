...
declare -A configfiles=( ["deterministic"]="experiments/imagenet21k_segmenter_cityscapes.py" ["sngp"]="experiments/imagenet21k_segmenter_cityscapes_sngp.py" )

num_cores=8
tpu='local'
use_gpu=False

for config_mode in "sngp" #"deterministic" #"sngp"
do
