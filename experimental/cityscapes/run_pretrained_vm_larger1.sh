...
declare -A configfiles=( ["deterministic"]="experiments/imagenet21k_segmenter_cityscapes_larger1.py" ["sngp"]="experiments/imagenet21k_segmenter_cityscapes_sngp.py" ["scratch"]="experiments/segmenter_cityscapes.py")
