...
from uncertainty_baselines.experimental.language_structure.vrnn.experiments.linear_vrnn import multiwoz_synth_tmpl as tmpl
...
def get_config():
  ...
  config.max_per_task_failures = 5
