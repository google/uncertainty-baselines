...
"""Input pipeline utilities for the CLIP experiments."""
...
def _get_dataset_builder(
  ...
  if isinstance(dataset, str):
    ...
    raise ValueError(
        "`dataset` must be a string or tfds.core.DatasetBuilder. "
...
def get_data(
  ...
  Args:
    ...
    ignore_errors: Whether to discard eroneous data after processing.
