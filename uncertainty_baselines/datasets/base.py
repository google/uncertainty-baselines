...
class BaseDataset(object):
  ...
  def build(self,
            ...
            **read_examples_kwargs) -> tf.data.Dataset:
    ...
    Args:
      ...
      ood_split: an optional OOD split, either one of the OodSplit enum or their
        associated strings.
      **read_examples_kwargs: extra kwargs needed for reading or filtering
        examples.
    ...
    dataset = self._read_examples(split, **read_examples_kwargs)
