...
"""ResNet50 with an approximate PI marginalization head."""
...
def resnet50_pi_full_marginalization(input_shape,
                                     pi_input_shape,
                                     num_classes,
                                     width_multiplier=1.,
                                     pi_tower_width=1024,
                                     ...
                                     name='resnet50_pi_fm'):
  """Builds width-resized ResNet50 with a PI access and an approximate full marginalization head.
  ...
  Args:
    ...
    name: Name to give to final Keras model
