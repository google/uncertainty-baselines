...
"""ResNet50 with TRAM layer model."""
...
def resnet50_tram(input_shape,
                  ...
                  name='resnet50_tram'):
  """Builds width-resized ResNet50 with a TRAM layer to ingest privileged information.
  ...
  return tf.keras.Model(
      inputs=(inputs, pi_inputs), outputs=(logits, logits_pi), name=name)
