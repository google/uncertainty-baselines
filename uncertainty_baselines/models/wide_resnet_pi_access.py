...
"""Wide Residual Network with PI access."""
...
def wide_resnet_pi_access(
  ...
  """Builds Wide ResNet with a PI access.
  ...
  return tf.keras.Model(  # pyrefly: ignore[bad-return]
      ...
      outputs=logits,
      name='wide_resnet-{}-{}-{}-pi-access'.format(depth, width_multiplier,
                                                   pi_tower_width))
